...
const documents = [
  ...
  urlDocument({
    selectors: { org: "unfoldingWord", lang: "en", abbr: "ult" },
    bookCode: "luk",
    filename: "43-LUK.usfm"
  }),
  urlDocument({
    selectors: { org: "unfoldingWord", lang: "en", abbr: "ult" },
    bookCode: "jhn",
    filename: "44-JHN.usfm"
  }),
...
function Component() {
  ...
  return (
    <>
      ...
      <h3>catalogHook</h3>
      <p>
        Tip... the raw output of the data for cv is intricate and takes a long
        time to render in ReactJson, so it is collapsed. Keep this in mind when
        rendering components based off of this information during an import.
        This demo is fast because the query is fast and not printed to screen
      ...
      <p>
        This is a filtered version of the data attribute and should be easier to
        work with.
      </p>
      <ReactJson
        style={{ maxHeight: "500px", overflow: "scroll", whiteSpace: "pre" }}
      ...
      <p>
        This is a raw data from the catalog query that is more verbose and
